...
export const personnelData: Personnel[] = [
  { id: '1', name: 'Mike Ross', role: 'Chief Flight Instructor', department: 'Flight Operations', email: 'mike.ross@skybound.com', phone: '555-0101', medicalExpiry: '2025-10-10', licenseExpiry: '2026-01-15', permissions: ['Flight Manager'] },
  ...
  { id: '5', name: 'Admin User', role: 'Accountable Manager', department: 'Management', email: 'admin@skybound.com', phone: '555-0100', medicalExpiry: '2099-01-01', licenseExpiry: '2099-01-01', permissions: ['Safety Manager', 'Quality Manager', 'Flight Manager', 'Fleet Manager', 'User Manager', 'Super User'] },
];
