...
export const userData: User[] = [
    ...
    { id: 'p6', companyId: 'skybound', name: 'John Smith', role: 'Safety Manager', department: 'Management', email: 'john.smith@skybound.com', phone: '555-0105', password: 'password', medicalExpiry: '2099-01-01', licenseExpiry: '2099-01-01', permissions: [] },
    { id: 'p7', companyId: 'skybound', name: 'Jessica Jones', role: 'Quality Manager', department: 'Management', email: 'jessica.jones@skybound.com', phone: '555-0106', password: 'password', permissions: [] },
    // Students
    { id: 's1', companyId: 'skybound', name: 'John Doe', role: 'Student', email: 'john.doe@email.com', phone: '555-0201', password: 'password', instructor: 'Mike Ross', flightHours: 45.5, progress: 75, medicalExpiry: '2025-01-01', licenseExpiry: '2025-06-01', status: 'Active', endorsements: studentEndorsements['s1'], trainingLogs: studentTrainingLogs['s1'], permissions: [] },
    { id: 's2', companyId: 'skybound', name: 'Jane Smith', role: 'Student', email: 'jane.smith@email.com', phone: '555-0202', password: 'password', instructor: 'Sarah Connor', flightHours: 22.0, progress: 40, medicalExpiry: '2024-07-20', licenseExpiry: '2025-02-10', status: 'Active', endorsements: studentEndorsements['s2'], trainingLogs: studentTrainingLogs['s2'], permissions: [] },
    { id: 's3', companyId: 'skybound', name: 'Peter Jones', role: 'Student', email: 'peter.jones@email.com', phone: '555-0203', password: 'password', instructor: 'Mike Ross', flightHours: 60.2, progress: 90, medicalExpiry: '2025-11-10', licenseExpiry: '2025-08-20', status: 'Active', endorsements: studentEndorsements['s3'], trainingLogs: studentTrainingLogs['s3'], permissions: [] },
    { id: 's4', companyId: 'skybound', name: 'Emily White', role: 'Student', email: 'emily.white@email.com', phone: '555-0204', password: 'password', instructor: 'Laura Croft', flightHours: 10.5, progress: 20, medicalExpiry: '2026-03-01', licenseExpiry: '2024-08-01', status: 'Archived', endorsements: studentEndorsements['s4'], trainingLogs: studentTrainingLogs['s4'], permissions: [] },
    { id: 's5', companyId: 'skybound', name: 'Chris Green', role: 'Student', email: 'chris.green@email.com', phone: '555-0205', password: 'password', instructor: 'Sarah Connor', flightHours: 35.8, progress: 65, medicalExpiry: '2025-09-15', licenseExpiry: '2025-09-15', status: 'Active', endorsements: studentEndorsements['s5'], trainingLogs: studentTrainingLogs['s5'], permissions: [] },
];
