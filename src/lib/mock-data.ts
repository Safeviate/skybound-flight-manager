...
export const personnelData: Personnel[] = [
  ...
  { id: '5', name: 'Admin User', role: 'Accountable Manager', department: 'Management', email: 'admin@skybound.com', phone: '555-0100', medicalExpiry: '2099-01-01', licenseExpiry: '2099-01-01', permissions: ['Safety Manager', 'Quality Manager', 'Flight Manager', 'Fleet Manager', 'User Manager'] },
];
