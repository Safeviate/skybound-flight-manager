...
export const riskRegisterData: Risk[] = [
    { 
      ...
      process: 'Approach',
      dateIdentified: '2024-08-10', 
      hazard: 'Bird Activity', 
      risk: 'Bird strike on approach/departure path', 
      consequences: ['Aircraft damage', 'Loss of control'],
      likelihood: 'Possible',
      likelihoodValue: 3,
      severity: 'Major',
      severityValue: 'A',
      riskScore: 16, 
      mitigation: 'Review bird dispersal procedures with airport operations. Advise pilots to increase vigilance.',
      residualLikelihood: 'Unlikely',
      residualLikelihoodValue: 2,
      residualSeverity: 'Moderate',
      residualSeverityValue: 'D',
      residualRiskScore: 6, 
    ...
    { 
      ...
      hazardArea: 'Flight Operations',
      process: 'Landing', 
      dateIdentified: '2024-08-12',
      hazard: 'Unstable Approach',
      risk: 'Student hard landings leading to aircraft damage', 
      consequences: ['Landing gear collapse', 'Runway excursion'],
      likelihood: 'Possible',
      likelihoodValue: 3,
      severity: 'Moderate',
      severityValue: 'B',
      riskScore: 12, 
      mitigation: 'Review landing training syllabus. Emphasize go-around procedure for unstable approaches.',
      riskOwner: 'Mike Ross', 
      reviewDate: '2024-11-12' 
    },
    { 
      id: 'risk3',
      hazardArea: 'Ground Operations',
      process: 'Servicing',
      dateIdentified: '2024-07-28',
      hazard: 'Faulty Equipment',
      risk: 'Fuel spillage at self-serve pumps',
      consequences: ['Fire hazard', 'Environmental contamination'],
      likelihood: 'Unlikely',
      likelihoodValue: 2,
      severity: 'Minor',
      severityValue: 'C',
      riskScore: 5, 
      mitigation: 'Faulty fuel pump handle replaced on 2024-07-29. Monitoring for further issues.',
      residualLikelihood: 'Rare',
      residualLikelihoodValue: 1,
      residualSeverity: 'Insignificant',
      residualSeverityValue: 'E',
      residualRiskScore: 1, 
      riskOwner: 'Hank Hill', 
    ...
    { 
      ...
      hazard: 'Pilot Error',
      risk: 'Runway incursion due to pilot error',
      consequences: ['Collision with other aircraft', 'Loss of life'],
      likelihood: 'Rare',
      likelihoodValue: 1,
      severity: 'Catastrophic',
      severityValue: 'A',
      riskScore: 20,
      mitigation: 'Mandatory training on airport signage and communication protocols. Review of hotspot map during pre-flight briefings.',
      riskOwner: 'John Smith', 
