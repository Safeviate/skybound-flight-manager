...
/**
 * The internal Genkit flow definition for generating the MOC plan.
 * This function is not exported as a server action.
 */
export const generateMocPlanFlow = ai.defineFlow(
  {
