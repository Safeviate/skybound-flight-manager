...
import type { CorrectiveAction, CorrectiveActionPlan, User } from '@/lib/types';
      ...
      <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Describe the identified root cause of the finding..." {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            className="w-full"
            onClick={() =>
              append({ action: '', isPreventative: false, responsiblePerson: '', completionDate: new Date(), status: 'Open' })
            }
          >
