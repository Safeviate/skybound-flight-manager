...
${data.keyAreasToInvestigate.map(item => `- ${item}`).join('\n')}

**Recommended Immediate Actions:**
${data.recommendedActions.map(item => `- ${item}`).join('\n')}

**Potential Contributing Factors:**
${data.potentialContributingFactors.join(', ')}

--- END OF AI SUGGESTIONS ---
`;
        onIncorporate(formattedText);
    };
      ...
      <Card className="mt-6">
        <CardHeader className="flex flex-row items-start justify-between">
          <div>
            ...
            <CardDescription>
              This plan was generated by AI. Review and incorporate it into your official notes.
            </CardDescription>
          </div>
          <Button variant="outline" size="sm" onClick={handleIncorporate}>
