  ...
  return (
    <div className="relative border rounded-lg overflow-x-auto">
      <div className="min-w-[1800px]">
        <div className="grid" style={{ gridTemplateColumns: `150px repeat(${totalHours}, 1fr)` }}>
            {/* Corner */}
            <div className="p-2 font-semibold bg-muted border-b border-r sticky top-0 left-0 z-20">Aircraft</div>
