      ...
      <main className="flex-1 p-4 md:p-8 space-y-8">
        <Card>
          ...
          <CardContent className="grid gap-y-12 md:gap-x-8 md:grid-cols-2">
            ...
            <div>
              <h3 className="text-lg font-semibold text-center mb-4">Total Flight Hours by Month</h3>
              <MonthlyFlightHoursChart />
            </div>
          </CardContent>
        </Card>
      </main>
